...
\markup \wordwrap {
  \bold { Young Collins } English Morris tune. Collected from the villages of Bledington and Oddington, Gloucestershire, in England's Cotswolds.
}
